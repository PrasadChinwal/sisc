...
<header class="absolute inset-x-0 top-0 z-50">
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
        <div class="flex lg:flex-1 text-center items-center">
            <a href="{{ route('home') }}" class="-m-1.5 p-1.5">
                <img src="{{ asset('images/person.svg') }}" alt="SISC Logo" class="h-8 w-auto dark:hidden" />
                <img src="{{ asset('images/person.svg') }}" alt="SISC Logo" class="h-8 w-auto not-dark:hidden" />
                <span class="sr-only">SISC</span>
            </a>
            <a href="{{ route('home') }}" class="px-3 font-mono uppercase tracking-wide font-bold dark:text-white">
                SISC
            </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a href="{{ route('announcement') }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Announcements</a>
            <a href="{{ route('gallery') }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Gallery</a>
            <a href="{{ route('team') }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Team</a>
            <a href="{{ route('about') }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white">About</a>
        </div>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="{{ route('filament.admin.auth.login') }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Log in <span aria-hidden="true">&rarr;</span></a>
        </div>
    </nav>
    <el-dialog>
                ...
                <el-dialog-panel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:bg-gray-900 dark:sm:ring-gray-100/10">
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10 dark:divide-gray-500/30">
                            ...
                            <div class="py-6">
                                <a href="{{ route('filament.admin.auth.login') }}" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Log in</a>
                            </div>
                        </div>
                    </div>
                </el-dialog-panel>
