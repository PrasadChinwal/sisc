<div class="bg-white dark:bg-gray-900">
    <main class="isolate">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="mt-16 flow-root sm:mt-24">
                        <div class="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-gray-900/10 ring-inset lg:-m-4 lg:rounded-2xl lg:p-4 dark:bg-white/2.5 dark:ring-white/10">
                            <img width="2432" height="1442" src="{{ asset('/images/team/team7.jpg') }}" alt="App screenshot" class="w-304 rounded-md bg-gray-50 shadow-xl ring-1 ring-gray-900/10 dark:hidden" />
                            <img width="2432" height="1442" src="{{ asset('/images/team/team7.jpg') }}" alt="App screenshot" class="w-304 rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 not-dark:hidden" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto mt-10 max-w-7xl px-6 sm:mt-20 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                ...
                <p class="mt-6 text-lg/8 text-gray-700 dark:text-gray-300">
                    We come together as a club to improve the game and skills to shape everyone into the best version of themselves.
                </p>
            </div>
                ...
                <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                    <div class="relative pl-16">
                        <dt class="text-base/7 font-semibold text-gray-900 dark:text-white">
                            <div class="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500">
                        ...
                        <dd class="mt-2 text-base/7 text-gray-600 dark:text-gray-400">
                            Our regular practices build the consistency and technical precision needed to excel on game day.  These sessions don't just improve your game; they build the teamwork and confidence that define a true champion.
                        </dd>
                    </div>
                    <div class="relative pl-16">
                        <dt class="text-base/7 font-semibold text-gray-900 dark:text-white">
                        ...
                        <dd class="mt-2 text-base/7 text-gray-600 dark:text-gray-400">
                            Our tournaments provide a high-energy stage for players to test their skills and thrive under pressure. Beyond the competition, these events unite our community and showcase the elite talent rising through Springfield International.
                        </dd>
                    </div>
                    <div class="relative pl-16">
                        <dt class="text-base/7 font-semibold text-gray-900 dark:text-white">
                        ...
                        <dd class="mt-2 text-base/7 text-gray-600 dark:text-gray-400">
                            We host regular friendly matches to provide players with valuable game-time experience in a low-pressure environment.  It’s where preparation meets play, helping our athletes stay sharp and connected between competitive fixtures.
                        </dd>
                    </div>
                    <div class="relative pl-16">
                        <dt class="text-base/7 font-semibold text-gray-900 dark:text-white">
                        ...
                        <dd class="mt-2 text-base/7 text-gray-600 dark:text-gray-400">
                            Beyond the pitch, our social gatherings build the lifelong friendships and community spirit that define our club. At Springfield International, we believe the strongest connections are made both during and after the game.
                        </dd>
                    </div>
                </dl>
            </div>
        ...
        <!-- Testimonial section -->
        <div class="mx-auto mt-20 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
            <div class="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20 dark:bg-black dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-0 dark:after:inset-ring dark:after:inset-ring-white/10 dark:after:sm:rounded-3xl">
                ...
                <div aria-hidden="true" class="absolute -top-56 -left-80 transform-gpu blur-3xl">
                    <div style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" class="aspect-1097/845 w-274.25 bg-linear-to-r from-[#ff4694] to-[#776fff] opacity-[0.45] dark:opacity-[0.30]"></div>
                </div>
                ...
                <div class="relative mx-auto max-w-2xl lg:mx-0">
                    ...
                    <figure>
                        ...
                        <figcaption class="mt-6 text-base text-white dark:text-gray-200">
                            <div class="font-semibold">Peter</div>
                            <div class="mt-1">President SISC</div>
                        </figcaption>
                    </figure>
                </div>
            </div>
                ...
                <div class="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <div class="-mr-px flex flex-col justify-between rounded-3xl bg-white p-8 inset-ring inset-ring-gray-200 lg:mt-8 lg:rounded-r-none xl:p-10 dark:bg-gray-800/50 dark:inset-ring-gray-700">
                        <div>
                            <div class="flex items-center justify-between gap-x-4">
                                <h3 id="tier-freelancer" class="text-lg/8 font-semibold text-gray-900 dark:text-white">
                                    Supporter
                                </h3>
                            </div>
                            <p class="mt-4 text-sm/6 text-gray-600 dark:text-gray-400">Show your support to the club and its members</p>
                            <p class="mt-6 flex items-baseline gap-x-1">
                                <span class="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">$50</span>
                    ...
                    <div class="flex flex-col justify-between rounded-3xl bg-white p-8 inset-ring inset-ring-gray-200 lg:z-10 lg:rounded-b-none xl:p-10 dark:bg-gray-800/50 dark:inset-ring-gray-700">
                        <div>
                            ...
                            <p class="mt-4 text-sm/6 text-gray-600 dark:text-gray-400">Attend practice and play tournaments</p>
                            <p class="mt-6 flex items-baseline gap-x-1">
                                <span class="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">$120</span>
                                <span class="text-sm/6 font-semibold text-gray-600 dark:text-gray-400">/year</span>
                            </p>
                            <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-600 dark:text-gray-400">
                                <li class="flex gap-x-3">
                                ...
                                <li class="flex gap-x-3">
                                    ...
                                    Earn 2 club jerseys (Home/Away)
                                </li>
                                <li class="flex gap-x-3">
                                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                    Attend practice sessions as per schedule
                                </li>
                                <li class="flex gap-x-3">
                                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                    Play tournaments (depends on team selection)
                                </li>
                                <li class="flex gap-x-3">
                                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                        ...
                        <a href="#" aria-describedby="tier-startup" class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:shadow-none dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500">Buy plan</a>
                    </div>
                    <div class="-ml-px flex flex-col justify-between rounded-3xl bg-white p-8 inset-ring inset-ring-gray-200 lg:mt-8 lg:rounded-l-none xl:p-10 dark:bg-gray-800/50 dark:inset-ring-gray-700">
                        <div>
                            <div class="flex items-center justify-between gap-x-4">
                                <h3 id="tier-enterprise" class="text-lg/8 font-semibold text-gray-900 dark:text-white">
                                    Loyalist
                                </h3>
                            </div>
                            <p class="mt-4 text-sm/6 text-gray-600 dark:text-gray-400">Dedicated support and infrastructure for your company.</p>
                            <p class="mt-6 flex items-baseline gap-x-1">
                                <span class="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">$150</span>
                                <span class="text-sm/6 font-semibold text-gray-600 dark:text-gray-400">/year</span>
                            </p>
                            <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-600 dark:text-gray-400">
                                <li class="flex gap-x-3">
                                    ...
                                    Everything from Member/Player
                                </li>
                                <li class="flex gap-x-3">
                                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                    1 Free club t-shirt (choose your size)
                                </li>
                                <li class="flex gap-x-3">
                                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                    Be part of the planning team for social events
                                </li>
                                <li class="flex gap-x-3">
                                    <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                                        <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                    Be part of other club activities
                                </li>
                            </ul>
                        </div>
        ...
        <!-- FAQs -->
        <div class="mx-auto max-w-2xl px-6 pb-8 sm:pt-12 sm:pb-16 lg:max-w-7xl lg:px-8 lg:pb-20">
        ...
        <!-- CTA section -->
        <div class="relative -z-10 mt-10 px-6 py-6 lg:px-8">
            <div aria-hidden="true" class="absolute inset-x-0 top-1/2 -z-10 flex -translate-y-1/2 transform-gpu justify-center overflow-hidden blur-3xl sm:top-auto sm:right-[calc(50%-6rem)] sm:bottom-0 sm:translate-y-0 sm:justify-end">
